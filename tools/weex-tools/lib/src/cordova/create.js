...
a dummy cordova-common.events EventEmitter with no listeners, then cordova-src
won't log in the create tests. When cordova-cli uses cordova-src, it will setup
