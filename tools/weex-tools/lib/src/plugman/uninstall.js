...
function runUninstallPlatform(actions, platform, project_dir, plugin_dir, plugins_dir, options) {
    ...
    if(projectRoot) {
        ...
        // platform inside of the existing CLI project. This option is usually set by cordova-src for CLI projects
...
function handleUninstall(actions, platform, pluginInfo, project_dir, www_dir, plugins_dir, is_top_level, options) {
    ...
    .then(function(result) {
        ...
        //     var buildModule;
        //     try {
        //         buildModule = require(path.join(project_dir, 'cordova', 'src', 'build'));
        //     } catch (e) {
