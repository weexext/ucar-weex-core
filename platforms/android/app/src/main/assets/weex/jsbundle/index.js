...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        onItemClick(item) {
            __WEBPACK_IMPORTED_MODULE_0__utils_router__["a" /* default */].push(item.page, {});
        }
    },
    data: {
        items: [
        // common
        { name: 'Router', page: 'views/pageA.js' },

        // component
        { name: 'Text', page: 'views/component/text.js' }, { name: 'Image', page: 'views/component/image.js' },
...
__vue_options__.__file = "/Users/dzc/que/ucar/ucar-weex/src/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-adc80782"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
