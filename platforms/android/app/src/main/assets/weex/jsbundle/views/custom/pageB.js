...
__vue_options__.__file = "/Users/dzc/que/ucar/ucar-weex/src/views/custom/pageB.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0792b159"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        ...
        onAndroidBack: function onAndroidBack() {
            _ucarWeex2.default.router.pop();
        },
        onClick: function onClick() {
            _ucarWeex2.default.router.popTo({ index: -1, tagCode: "pageb", param: { test: 'testB' } }, function () {});
        }
    }
