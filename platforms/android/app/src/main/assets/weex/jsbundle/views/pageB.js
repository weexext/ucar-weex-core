...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        onClick() {
            __WEBPACK_IMPORTED_MODULE_0__utils_router__["a" /* default */].popTo(1, "backTag", {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "backgroundColor": "#3e50b5",
      "title": "pageB",
      "leftItemSiblingSrc": _vm.imgClose
    },
    on: {
      "naviBarLeftSiblingItemClick": _vm.naviBarLeftSiblingItemClick,
      "naviBarLeftItemClick": _vm.naviBarLeftItemClick
...
__vue_options__.__file = "/Users/dzc/que/ucar/ucar-weex/src/views/pageB.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-03b39742"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
