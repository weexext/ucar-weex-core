...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_index__ = __webpack_require__(0);
...
function push(page, params = {}) {
    let url = __WEBPACK_IMPORTED_MODULE_0__config_index__["default"].js(page);
    let newParams = {
        param: params,
        navBar: {
            hasBack: true,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_router__ = __webpack_require__(9);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        naviBarLeftItemClick(e) {
            __WEBPACK_IMPORTED_MODULE_0__utils_router__["a" /* default */].popTo(1, {});
        },
        onAndroidBack() {
            __WEBPACK_IMPORTED_MODULE_0__utils_router__["a" /* default */].pop(() => {});
        },
        onClick() {
            __WEBPACK_IMPORTED_MODULE_0__utils_router__["a" /* default */].push('pageB.js', {
                api: "push",
                from: "pageA",
                to: 'pageB'
            });
...
__vue_options__.__file = "/Users/dzc/que/ucar/ucar-weex/src/views/pageA.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-03cfc644"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
