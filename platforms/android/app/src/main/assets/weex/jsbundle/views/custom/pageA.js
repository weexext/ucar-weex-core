...
var _UString = __webpack_require__(205);
...
exports.default = {
    ...
    created: function created() {
        ...
        console.log(param);
        _ucarWeex2.default.bridge.addEventListener('test', function (e) {
    ...
    methods: {
        ...
        naviBarLeftItemClick: function naviBarLeftItemClick(e) {
            ...
            _ucarWeex2.default.router.popTo(options, function () {});
        },
        onAndroidBack: function onAndroidBack() {
            _ucarWeex2.default.router.pop();
        },
        onClick: function onClick() {
            _ucarWeex2.default.router.push({
                url: 'pageB.js',
                param: {
                    api: "push"
                }
