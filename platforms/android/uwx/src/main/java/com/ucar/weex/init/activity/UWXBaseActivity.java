...
public class UWXBaseActivity extends FragmentActivity implements IWXRenderListener {
    private static final String TAG = UWXBaseActivity.class.getSimpleName();
