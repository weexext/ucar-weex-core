...
public class WXDebugActivity extends Activity implements View.OnClickListener {
    ...
    private void setData() {
        ...
        if (wxEnvDetail != null) {
            ...
            String[] mItems = new String[values.length];
            for (int i = 0; i < values.length; i++) {
                mItems[i] = values[i].getName();
            }
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    if (wxEnvDetail != null) {
                        wxEnvDetail.logLevel = values[position];
            ...
            int select = ArrayUtils.indexOf(mItems, wxEnvDetail.logLevel.getName());
