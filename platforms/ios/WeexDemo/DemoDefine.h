...
#define DEMO_URL(path) [NSString stringWithFormat:@"http://%@:12588/%s", DEMO_HOST, #path]
...
#define UITEST_HOME_URL @"http://test?_wx_tpl=http://localhost:12588/test/build/TC__Home.js"
